...
Moving from email provider *is* a bit of a pain. Migrating over all your emails and contacts, and setting up an auto-forwarding rule on your old email is [just a couple clicks](https://proton.me/easyswitch). But you'll need to update all your digital accounts to use your new emailadress. Couple of tips:

- Update all your main accounts in one go, and then updating accounts from services when you receive email from them. 
...
- Take ownership of your old data. You can download a copy of your entire email history using export services like [Google Takeout](https://takeout.google.com/). I'm watching new projects like [msgvault](https://www.msgvault.io/) (from WesMckinney, creator of `pandas`) helps manage, sync and search your message history locally.

### Use a different authenticator app

All your important accounts have two factor authentication (2FA) setup.. right? If not, get that in order. A simple username/password is too insecure and your digital identity too important.
...
- Calendar: First own calendar data, and add it as as a feed to whatever (web) app you like best. I recommend [Proton Calendar](https://proton.me/calendar).
...
If you are slightly technical: build your own homelab. 2026 is the year. The software has become very mature. The hardware has become incredibly powerfull, afforable and surprisingly small and quiet. And AI can assist you with setting everything up in a breeze. No nerdy sysadmin friend required.
...
- [immich](https://immich.app/) replaces photo backup/viewing services [google photos](https://photos.google.com/)
...
- [vaultwarden](https://github.com/dani-garcia/vaultwarden) can replace replacing password manager services like [Lastpass](https://www.lastpass.com/) or [1password](https://1password.com/)
...
There is so much more. To name a few: [Home Assistent](https://www.home-assistant.io/) to run your smart home, [cal.com](https://cal.com/) to manage calendar invites, [pi-hole](https://pi-hole.net/) to block ads on your network, [gitlab](https://about.gitlab.com/) to version control your code, [plausible](https://plausible.io/) to safely track visitors to your website, [endurain](https://github.com/endurain-project/endurain) to sync your sports data from Garmin and Strava, and [Campfire](https://once.com/campfire) to host your own group chat.
...
Don't wait and see. Sure, probably everything will be fine. Except that one time when it's not. For me digital sovereignty is not a bad thing, it's a push progress. A way of out complacency. The diversity and decentralization of these services is going to make our all digital lives better and more exciting.
